 ...
 *  @generated
 */
package com.uuhnaut69.thrift.impl;

@SuppressWarnings({ "cast", "rawtypes", "serial", "unchecked", "unused" })
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.12.0)", date = "2019-07-22")
public class CrossPlatformService {
	...
	public interface AsyncIface {
		...
		public void get(int id, org.apache.thrift.async.AsyncMethodCallback<CrossPlatformResource> resultHandler)
		...
		public void getList(
				org.apache.thrift.async.AsyncMethodCallback<java.util.List<CrossPlatformResource>> resultHandler)
				throws org.apache.thrift.TException;

		public void ping(org.apache.thrift.async.AsyncMethodCallback<java.lang.Boolean> resultHandler)
				throws org.apache.thrift.TException;
	...
	public static class Client extends org.apache.thrift.TServiceClient implements Iface {
		...
		public java.util.List<CrossPlatformResource> recv_getList()
				throws InvalidOperationException, org.apache.thrift.TException {
	...
	public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
		...
		public static class get_call extends org.apache.thrift.async.TAsyncMethodCall<CrossPlatformResource> {
			...
			public get_call(int id, org.apache.thrift.async.AsyncMethodCallback<CrossPlatformResource> resultHandler,
		...
		public static class save_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
			...
			public save_call(CrossPlatformResource resource,
		...
		public static class getList_call
				extends org.apache.thrift.async.TAsyncMethodCall<java.util.List<CrossPlatformResource>> {
			public getList_call(
					org.apache.thrift.async.AsyncMethodCallback<java.util.List<CrossPlatformResource>> resultHandler,
					org.apache.thrift.async.TAsyncClient client,
					org.apache.thrift.protocol.TProtocolFactory protocolFactory,
			...
			public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
				prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("getList",
						org.apache.thrift.protocol.TMessageType.CALL, 0));
				getList_args args = new getList_args();
				args.write(prot);
				prot.writeMessageEnd();
			...
			public java.util.List<CrossPlatformResource> getResult()
					throws InvalidOperationException, org.apache.thrift.TException {
				if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
					throw new java.lang.IllegalStateException("Method call not finished!");
				}
		...
		public static class ping_call extends org.apache.thrift.async.TAsyncMethodCall<java.lang.Boolean> {
			public ping_call(org.apache.thrift.async.AsyncMethodCallback<java.lang.Boolean> resultHandler,
					org.apache.thrift.async.TAsyncClient client,
					org.apache.thrift.protocol.TProtocolFactory protocolFactory,
					org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
				super(client, protocolFactory, transport, resultHandler, false);
	...
	public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
		...
		public static class get<I extends AsyncIface>
				extends org.apache.thrift.AsyncProcessFunction<I, get_args, CrossPlatformResource> {
			public get() {
				super("get");
			}
			...
			public org.apache.thrift.async.AsyncMethodCallback<CrossPlatformResource> getResultHandler(
			...
			public void start(I iface, get_args args,
					org.apache.thrift.async.AsyncMethodCallback<CrossPlatformResource> resultHandler)
					throws org.apache.thrift.TException {
				iface.get(args.id, resultHandler);
			}
		}

		public static class save<I extends AsyncIface>
				extends org.apache.thrift.AsyncProcessFunction<I, save_args, Void> {
			public save() {
				super("save");
			}
			...
			public void start(I iface, save_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler)
					throws org.apache.thrift.TException {
				iface.save(args.resource, resultHandler);
			}
		}

		public static class getList<I extends AsyncIface>
				extends org.apache.thrift.AsyncProcessFunction<I, getList_args, java.util.List<CrossPlatformResource>> {
			public getList() {
				super("getList");
			}
			...
			public org.apache.thrift.async.AsyncMethodCallback<java.util.List<CrossPlatformResource>> getResultHandler(
					final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
				final org.apache.thrift.AsyncProcessFunction fcall = this;
			...
			public void start(I iface, getList_args args,
					org.apache.thrift.async.AsyncMethodCallback<java.util.List<CrossPlatformResource>> resultHandler)
					throws org.apache.thrift.TException {
		...
		public static class ping<I extends AsyncIface>
				extends org.apache.thrift.AsyncProcessFunction<I, ping_args, java.lang.Boolean> {
			public ping() {
				super("ping");
			}
	...
	public static class get_result implements org.apache.thrift.TBase<get_result, get_result._Fields>,
			...
			tmpMap.put(_Fields.SUCCESS,
					new org.apache.thrift.meta_data.FieldMetaData("success",
							...
							new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT,
									CrossPlatformResource.class)));
			tmpMap.put(_Fields.E,
					new org.apache.thrift.meta_data.FieldMetaData("e", org.apache.thrift.TFieldRequirementType.DEFAULT,
							new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT,
		...
		public get_result(CrossPlatformResource success, InvalidOperationException e) {
			this();
	...
	public static class save_args implements org.apache.thrift.TBase<save_args, save_args._Fields>,
		...
		private static final org.apache.thrift.protocol.TField RESOURCE_FIELD_DESC = new org.apache.thrift.protocol.TField(
				"resource", org.apache.thrift.protocol.TType.STRUCT, (short) 1);
		...
		static {
			java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new java.util.EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(
					_Fields.class);
			tmpMap.put(_Fields.RESOURCE,
					new org.apache.thrift.meta_data.FieldMetaData("resource",
							org.apache.thrift.TFieldRequirementType.DEFAULT,
							new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT,
									CrossPlatformResource.class)));
			metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
		...
		public save_args(CrossPlatformResource resource) {
			this();
			this.resource = resource;
		}
		...
		/**
		 * Returns true if field resource is set (has been assigned a value) and false
		 * otherwise
		 */
	...
	public static class save_result implements org.apache.thrift.TBase<save_result, save_result._Fields>,
			java.io.Serializable, Cloneable, Comparable<save_result> {
		private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
				"save_result");
		...
		public save_result(InvalidOperationException e) {
			this();
			this.e = e;
		}
	...
	public static class getList_args implements org.apache.thrift.TBase<getList_args, getList_args._Fields>,
			java.io.Serializable, Cloneable, Comparable<getList_args> {
		private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
				"getList_args");
		...
		private static class getList_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<getList_args> {
			...
			public void read(org.apache.thrift.protocol.TProtocol iprot, getList_args struct)
					throws org.apache.thrift.TException {
				org.apache.thrift.protocol.TField schemeField;
				iprot.readStructBegin();
				while (true) {
			...
			public void write(org.apache.thrift.protocol.TProtocol oprot, getList_args struct)
					throws org.apache.thrift.TException {
				struct.validate();
		...
		private static class getList_argsTupleScheme extends org.apache.thrift.scheme.TupleScheme<getList_args> {
			...
			@Override
			public void write(org.apache.thrift.protocol.TProtocol prot, getList_args struct)
					throws org.apache.thrift.TException {
				org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
			}

			@Override
			public void read(org.apache.thrift.protocol.TProtocol prot, getList_args struct)
					throws org.apache.thrift.TException {
				org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
			}
		}
	...
	public static class getList_result implements org.apache.thrift.TBase<getList_result, getList_result._Fields>,
			java.io.Serializable, Cloneable, Comparable<getList_result> {
		private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
				"getList_result");
		...
		public getList_result(java.util.List<CrossPlatformResource> success, InvalidOperationException e) {
			this();
			this.success = success;
			this.e = e;
		}
		...
		public getList_result(getList_result other) {
			if (other.isSetSuccess()) {
				java.util.List<CrossPlatformResource> __this__success = new java.util.ArrayList<CrossPlatformResource>(
						other.success.size());
		...
		public getList_result setSuccess(
				@org.apache.thrift.annotation.Nullable java.util.List<CrossPlatformResource> success) {
			this.success = success;
			return this;
		}
		...
		private static class getList_resultStandardScheme
				extends org.apache.thrift.scheme.StandardScheme<getList_result> {

			public void read(org.apache.thrift.protocol.TProtocol iprot, getList_result struct)
					throws org.apache.thrift.TException {
				org.apache.thrift.protocol.TField schemeField;
				iprot.readStructBegin();
				while (true) {
			...
			public void write(org.apache.thrift.protocol.TProtocol oprot, getList_result struct)
					throws org.apache.thrift.TException {
				struct.validate();
		...
		private static class getList_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<getList_result> {
			...
			@Override
			public void write(org.apache.thrift.protocol.TProtocol prot, getList_result struct)
					throws org.apache.thrift.TException {
				org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
				java.util.BitSet optionals = new java.util.BitSet();
				if (struct.isSetSuccess()) {
			...
			@Override
			public void read(org.apache.thrift.protocol.TProtocol prot, getList_result struct)
					throws org.apache.thrift.TException {
				org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
				java.util.BitSet incoming = iprot.readBitSet(2);
				if (incoming.get(0)) {
	...
	public static class ping_result implements org.apache.thrift.TBase<ping_result, ping_result._Fields>,
		...
		public ping_result(boolean success, InvalidOperationException e) {
			this();
			this.success = success;
